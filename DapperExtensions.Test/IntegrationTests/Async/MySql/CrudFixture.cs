...
namespace DapperExtensions.Test.IntegrationTests.Async.MySql
{
    ...
    public static class CrudFixture
    {
        ...
        public class DeleteMethod : MySqlBaseAsyncFixture
        {
            ...
            {
                Db.InsertAsync(new Person { Active = true, FirstName = "Foo", LastName = "Bar", DateCreated = DateTime.UtcNow });
                Db.InsertAsync(new Person { Active = true, FirstName = "Foo", LastName = "Bar", DateCreated = DateTime.UtcNow });
                Db.InsertAsync(new Person { Active = true, FirstName = "Foo", LastName = "Barz", DateCreated = DateTime.UtcNow });
            }
