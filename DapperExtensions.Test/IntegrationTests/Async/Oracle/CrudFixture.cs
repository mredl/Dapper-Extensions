    ...
    public static class CrudFixture
    {
        ...
        public class DeleteMethod : OracleBaseAsyncFixture
        {
            ...
            public void UsingCompositeKey_DeletesFromDatabase()
            {
                ...
                var m2 = Db.GetAsync<Multikey>(new { key.Key1, key.Key2 }).Result;
                var result = Db.DeleteAsync(m2).Result;
        ...
        public class GetListMethod : OracleBaseAsyncFixture
        {
            ...
            {
                Db.InsertAsync(new Person { Active = "Y", FirstName = "a", LastName = "a1", DateCreated = DateTime.UtcNow });
                Db.InsertAsync(new Person { Active = "N", FirstName = "b", LastName = "b1", DateCreated = DateTime.UtcNow });
                Db.InsertAsync(new Person { Active = "Y", FirstName = "c", LastName = "c1", DateCreated = DateTime.UtcNow });
                Db.InsertAsync(new Person { Active = "N", FirstName = "d", LastName = "d1", DateCreated = DateTime.UtcNow });
            }
        ...
        public class GetPageMethod : OracleBaseAsyncFixture
        {
            ...
            {
                id1 = Db.InsertAsync(new Person { Active = "Y", FirstName = "Sigma", LastName = "Alpha", DateCreated = DateTime.UtcNow }).Result;
                id2 = Db.InsertAsync(new Person { Active = "N", FirstName = "Delta", LastName = "Alpha", DateCreated = DateTime.UtcNow }).Result;
                id3 = Db.InsertAsync(new Person { Active = "Y", FirstName = "Theta", LastName = "Gamma", DateCreated = DateTime.UtcNow }).Result;
                id4 = Db.InsertAsync(new Person { Active = "N", FirstName = "Iota", LastName = "Beta", DateCreated = DateTime.UtcNow }).Result;
            }
        ...
        public class CountMethod : OracleBaseAsyncFixture
        {
            private void Arrange()
            {
                Db.InsertAsync(new Person { Active = "Y", FirstName = "a", LastName = "a1", DateCreated = DateTime.UtcNow.AddDays(-10) });
                Db.InsertAsync(new Person { Active = "N", FirstName = "b", LastName = "b1", DateCreated = DateTime.UtcNow.AddDays(-10) });
                Db.InsertAsync(new Person { Active = "Y", FirstName = "c", LastName = "c1", DateCreated = DateTime.UtcNow.AddDays(-3) });
                Db.InsertAsync(new Person { Active = "N", FirstName = "d", LastName = "d1", DateCreated = DateTime.UtcNow.AddDays(-1) });
            }
